 ...
 * <p>
 * Each tile has a type. It can be a Wall, Start, End, Unvisited, Visited or
 * Pushed tile. Each tile type will be a different colour: black, green, red,
 * cyan, blue and magenta respectively.
 * <p>
...
public class Hexagon extends HexComponent {
	...
	public static enum HexType {
		WALL, START, END, UNVISITED, PROCESSED, PUSHED, END_PROCESSED, START_PROCESSED
	};
	...
	/**
	 * This method sets the tile to be a Pushed tile and updates the tile's colour
	 */
	...
	/**
	 * This method set the tile to be a Visited tile and updates the tile's colour
	 */
